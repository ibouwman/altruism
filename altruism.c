...
void printRunInfoToFile(FILE *filename, int timestep){
	if(timestep == 0){
		...
		fprintf(filename,
				"Timestep Time Population_size As Bs Mean_altruism_all Mean_altruism_A Mean_altruism_B Mean_p_all Mean_p_A Mean_p_B Mean_cost_all Mean_cost_A Mean_cost_B Mean_benefit_all Mean_benefit_A Mean_benefit_B Mean_production_all Mean_production_A Mean_production_B Covariance_p_altruism Mean_expressed_altruism\n");
	}
	if(timestep % OUTPUTINTERVAL == 0){
		double total_altruism = 0; double total_p = 0; double total_cost = 0; double total_benefit = 0; double total_production = 0;
		double total_altruism_A = 0; double total_p_A = 0; double total_cost_A = 0; double total_benefit_A = 0; double total_production_A = 0;
		...
		fprintf(filename, "%d %f %d %d %d %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n", timestep, timestep*DELTATIME, population_size_old, A_counter, B_counter,
				...
				mean_production, mean_production_A, mean_production_B, covariance_p_altruism, mean_expressed_altruism);
	}
}
